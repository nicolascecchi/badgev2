...
class ActiveLearningByLearning(Strategy):
	def __init__(self, X, Y, idxs_lb, idxs_val, net, handler, args, strategy_list, delta = 0.1):
		super(ActiveLearningByLearning, self).__init__(X, Y, idxs_lb, idxs_val, net, handler, args)
